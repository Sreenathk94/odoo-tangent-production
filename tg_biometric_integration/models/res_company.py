        ...
        try:
            ...
            for employee in employee_ids:
                ...
                if result_set:
                    ...
                    self.env['hr.attendance'].create({'fetch_date':self.fetch_date,'employee_id':employee.id,'line_ids':lines,'check_in':first_check_in[1],'check_out':last_check_out[2]if last_check_out[2].year!=1970 else last_check_out[1]})
